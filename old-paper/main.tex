...
\title{ A unified decision making framework for supply and demand management in microgrid networks}
...
\author{
	...
	\IEEEauthorblockN{D. Raghuram Bharadwaj$^\dagger$}
	\IEEEauthorblockA{Dept of CSA,\\
		Indian Institute of Science, 
		Bangalore, India \\
	Email: raghub@iisc.ac.in} \and
\IEEEauthorblockN{D. Sai Koti Reddy$^\dagger$,\\
...
\IEEEauthorblockA{Dept of CSA and RBCCPS\\
Indian Institute of Science, 
Bangalore, India \\
Email: shalabh@iisc.ac.in}
\thanks{$^\dagger$ Both of these authors are joint first authors, in this paper}
}
